...
res = attr_cy.run(samples=100000, steps=100, debug=False, progress=True, on_states=['FGFR', 'DNA_damage', 'FGFR3_stimulus', 'TGFBR_stimulus', 'p53', 'p38', 'PKC', 'GRB2', 'GAB1'], off_states=['p14', 'EGFR_stimulus', 'ERK'])
